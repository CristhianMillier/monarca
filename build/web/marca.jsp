...
<html lang="es">
    ...
    <body class="sb-nav-fixed" onload="noAtras()">
        <div class="container-fluid px-4 mt-4">
            ...
            <div class="card">
                <div class="card-header"><i class="bi bi-bookmark-star-fill"></i> Marca</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <button type="button" class="btn btn-success" onclick="abrirModal();">Nueva Marca</button>
                        </div>
                    </div>
                    <hr />
                        ...
                        <tbody>
                            <c:forEach var="list" items="${listaMarca}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="Marca?accion=subEditar&idM=${list.getId()}"><i class="fas fa-pen"></i></a>
                            ...
                            <div class="modal-body">
                                <div class="row g-2">
                                    <div class="col-sm-6 requerido">
                                        ...
                                        <input id="nombre" type="text" class="form-control" name="nombreMar" required autocomplete="off" value="${objMar.getNombre()}">
                                    </div>
                                    <div class="col-sm-6 requerido">
                                        <label class="form-label">Activo</label>
                                        <select id="activo" class="form-select" name="estado">
                                            <c:if test="${objMar == null}">
                                            ...
                                            <c:if test="${objMar != null}">
                                                ...
                                                <c:if test="${objMar.getEstado() == 'Si'}">
                                                    <option selected value="Si">Activo</option>
                                                    <option value="No">Inactivo</option>
                                                </c:if>
                                                <c:if test="${objMar.getEstado() == 'No'}">
                                                    <option value="Si">Activo</option>
    ...
    <script>
        ...
        function verficarEliminar(idMar) {
            let describe = "#Tablaestado-" + idMar;
            ...
            if (valores === "Si") {
                swal({
                    ...
                    closeOnConfirm: false
                        ...
                        function () {
                            let url = "Marca?accion=eliminar&idMarca=" + idMar;
                            document.location.href = url;
                        });
            } else {
                swal("Marca ya elimada!!");
            }
        }
